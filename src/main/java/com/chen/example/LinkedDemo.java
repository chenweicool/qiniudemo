    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            DeviceHistoryListing history= deviceManager.listDeviceHistory(testAppid,testDeviceName1,
                    0,(System.currentTimeMillis())/1000,"",0);
        }catch (QiniuException e){
            System.out.println(e.error());
        }
        ...
        try{
            ...
            //生成视频相关功能的token
            token = auth.generateLinkingDeviceVodTokenWithExpires(testAppid,testDeviceName1,1000);
            //生成获取设备状态的token
            token = auth.generateLinkingDeviceStatusTokenWithExpires(testAppid,testDeviceName1,1000);
